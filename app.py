...
def train() -> Union[Response, Tuple[Response, int]]:
    ...
    activations: List[str] = req_data.get(
    ...
    train_loader: Any = data_handler.get_dataloader(
    ...
    for epoch in range(epochs):
        ...
        for images, labels in train_loader:
            ...
            if batch_idx % 100 == 0:
                add_log(
                    f"Epoch {epoch+1} | Processed batch {batch_idx}...", "DEBUG")
            batch_idx += 1
...
def evaluate() -> Union[Response, Tuple[Response, int]]:
    ...
    data_handler: Data = Data()
    test_loader: Any = data_handler.get_dataloader(
